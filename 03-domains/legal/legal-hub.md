...
The legal layer is what turns technical findings into money and protection. Every defect page must carry a "legal weapon" tag; every phase page cites the statutes that create its deadlines.
...
DL 118/2013 (mediation regime, seller alignment) · Mais Habitação package (AL containment zones, rental reform) · RRAA / DL 129/2002 (acoustics — covered inside [[acoustic-defects]]) · DL 220/2008 + Portaria 1532/2008 (SCIE — inside [[scie-fire-safety]]) · DL 53/2018 (RAVS — inside [[seismic-risk]]) · Código das Sociedades Comerciais (SPV liability shields, developer-suing mechanics).

> [!warning] Annual re-verification
> IMT brackets, AL containment-zone lists, and tax figures change with each State Budget and municipal deliberation. Any page citing them carries a verification date.
